    ...
    var OrdersController = _classThis = class {
        ...
        create(orderData) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield this.ordersService.create(orderData);
            });
        }
        // Get all orders
        findAll() {
        ...
        findOne(id) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield this.ordersService.findOne(id);
            });
        }
        // Update an order
        update(id, orderData) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield this.ordersService.update(id, orderData);
            });
        }
        // Delete an order
        remove(id) {
            return __awaiter(this, void 0, void 0, function* () {
                return yield this.ordersService.remove(id);
            });
        }
    };
